                ...
                <div class="card p-2 text-center">
                   ...
                   <hr />
                    ...
                    <div>
                        ...
                        <asp:Button ID="BtnUserLogin" runat="server" ValidationGroup="Val_cc" Text="Get Otp" class="btn btn-danger" Style="border-radius: 4px; background-color: #dc3545; color: white;" Height="40px" OnClick="BtnUserLogin_Click" /><br />
                  ...
                  <div class="card-2">
                    <div class="content d-flex justify-content-center align-items-center"><span>Didn't Account ?</span> <a href="UserSignup.aspx" class="text-decoration-none ms-3">New User</a> </div>
                </div>
            </div>
        </div>
